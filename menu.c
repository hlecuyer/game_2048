...
/*   Updated: 2015/03/01 15:10:43 by fmarmol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	check_entry(t_env *env, ITEM *cur, ITEM **my_items, MENU *my_menu)
{
...
int			menu(t_env *env)
{
	...
	return (check_entry(env, cur, my_items, my_menu));
}
